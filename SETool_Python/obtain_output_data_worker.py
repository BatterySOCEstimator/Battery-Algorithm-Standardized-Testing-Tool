...
from validate_submission import load_python_model, PythonModelWrapper

def distributed_output_data(setups, data, inputs, processing_folder):
    ...
    # Re-hydrate the model from the file we uploaded
    model_module = load_python_model(processing_folder)
